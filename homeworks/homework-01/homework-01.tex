...
% Homework problem 4
\begin{homeworkProblem}
	Let $V$ denote the set of ordered pairsa of real numbers. If $(a_1, a_2)$ and $(b_1, b_2)$ are
	elements of $V$ and $c \in R$, define
	$(a_1, a_2) + (b_1, b_2) = (a_1 + b_1, a_2 b_2) \text{ and } c(a_1, a_2) = (ca_1, ca_2)$.
	\[
		\begin{split}
			d
		\end{split}
